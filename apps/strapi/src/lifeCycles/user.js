...
exports.registerUserSubscriber = void 0;
const crypto = require("crypto");
const registerUserSubscriber = async ({ strapi, }) => {
...
exports.registerUserSubscriber = registerUserSubscriber;
/**
...
const sendEmail = async (strapi, event) => {
    ...
    if (!feAccountActivationUrl) {
        console.warn("CLIENT_ACCOUNT_ACTIVATION_URL is not set. After creation email will not be sent.");
        return;
    }
