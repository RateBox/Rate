...
export class SmartComponentFilterHelper {
  static listAllComponents(components: ComponentData[]) {
  ...
  static saveConfiguration(componentUIDs: string[]) {
    try {
      const config = {
...
// Global access
(window as any).SmartComponentFilter = SmartComponentFilterHelper;
