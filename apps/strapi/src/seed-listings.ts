/**
 * Seed script to create sample Listings directly using Strapi SDK
 * Run from Strapi directory: npx ts-node src/seed-listings.ts
 */

async function seedListings(strapi: any) {
  ...
  for (const [index, listing] of listings.entries()) {
    try {
      ...
      const dataWithRelations: any = { ...listing };
...
// Bootstrap function to initialize Strapi and run seed
