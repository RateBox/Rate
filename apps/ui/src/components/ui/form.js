...
const FormDescription = React.forwardRef(({ className, ...props }, ref) => {
    ...
    return (<p ref={ref} id={formDescriptionId} className={(0, utils_1.cn)("text-muted-foreground text-[0.8rem]", className)} {...props}/>);
});
...
const FormMessage = React.forwardRef(({ className, children, ...props }, ref) => {
    ...
    return (<p ref={ref} id={formMessageId} className={(0, utils_1.cn)("text-destructive text-[0.8rem] font-medium", className)} {...props}>
      {body}
    </p>);
});
