...
const Logo_1 = require("@/components/salient/Logo");
const NavLink_1 = require("@/components/salient/NavLink");
function Footer() {
    return (<footer className="bg-slate-50">
      <Container_1.Container>
        <div className="py-16">
          <Logo_1.Logo className="mx-auto h-10 w-auto"/>
        ...
        <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
          <div className="flex gap-x-6">
            <link_1.default href="#" className="group" aria-label="TaxPal on X">
            ...
            <link_1.default href="#" className="group" aria-label="TaxPal on GitHub">
              <svg className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700" aria-hidden="true" viewBox="0 0 24 24">
