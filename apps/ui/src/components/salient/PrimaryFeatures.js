...
const backgroundImage = '/images/salient/background-features.jpg';
const screenshotExpenses = '/images/salient/screenshots/expenses.png';
const screenshotPayroll = '/images/salient/screenshots/payroll.png';
const screenshotReporting = '/images/salient/screenshots/reporting.png';
const screenshotVatReturns = '/images/salient/screenshots/vat-returns.png';
const features = [
    {
        title: 'Payroll',
...
function PrimaryFeatures() {
    ...
    return (<section id="features" aria-label="Features for running your books" className="relative overflow-hidden bg-blue-600 pt-20 pb-28 sm:py-32">
      <image_1.default className="absolute top-1/2 left-1/2 max-w-none translate-x-[-44%] translate-y-[-42%]" src={backgroundImage} alt="" width={2245} height={1636} unoptimized/>
              ...
              <react_2.TabPanels className="lg:col-span-7">
                {features.map((feature) => (<react_2.TabPanel key={feature.title} unmount={false}>
                    ...
                    <div className="mt-10 w-180 overflow-hidden rounded-xl bg-slate-50 shadow-xl shadow-blue-900/20 sm:w-auto lg:mt-0 lg:w-271.25">
                      <image_1.default className="w-full" src={feature.image} alt="" width={1084} height={800} priority sizes="(min-width: 1024px) 67.8125rem, (min-width: 640px) 100vw, 45rem"/>
                    </div>
                  </react_2.TabPanel>))}
              </react_2.TabPanels>
            </>)}
