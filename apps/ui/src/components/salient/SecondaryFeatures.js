...
const Container_1 = require("@/components/salient/Container");
const screenshotContacts = '/images/salient/screenshots/contacts.png';
const screenshotInventory = '/images/salient/screenshots/inventory.png';
const screenshotProfitLoss = '/images/salient/screenshots/profit-loss.png';
const features = [
    {
        name: 'Reporting',
      ...
      {features.map((feature) => (<div key={feature.summary}>
          ...
          <div className="relative mt-10 pb-10">
            ...
            <div className="relative mx-auto w-211 overflow-hidden rounded-xl bg-white shadow-lg ring-1 shadow-slate-900/5 ring-slate-500/10">
              <image_1.default className="w-full" src={feature.image} alt="" width={844} height={600} sizes="52.75rem"/>
            </div>
          </div>
        </div>))}
    </div>);
