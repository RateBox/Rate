...
exports.BadgeButton = exports.Badge = void 0;
...
function Badge({ color = 'zinc', className, ...props }) {
    return (<span {...props} className={(0, clsx_1.default)(className, 'inline-flex items-center gap-x-1.5 rounded-md px-1.5 py-0.5 text-sm/5 font-medium sm:text-xs/5 forced-colors:outline', colors[color])}/>);
}
exports.Badge = Badge;
exports.BadgeButton = (0, react_1.forwardRef)(function BadgeButton({ color = 'zinc', className, children, ...props }, ref) {
    let classes = (0, clsx_1.default)(className, 'group relative inline-flex rounded-md focus:not-data-focus:outline-hidden data-focus:outline-2 data-focus:outline-offset-2 data-focus:outline-blue-500');
