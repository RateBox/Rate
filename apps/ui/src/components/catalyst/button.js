...
exports.TouchTarget = exports.Button = void 0;
...
exports.Button = (0, react_1.forwardRef)(function Button({ color, outline, plain, className, children, ...props }, ref) {
    let classes = (0, clsx_1.default)(className, styles.base, outline ? styles.outline : plain ? styles.plain : (0, clsx_1.default)(styles.solid, styles.colors[color ?? 'dark/zinc']));
    return 'href' in props ? (<link_1.Link {...props} className={classes} ref={ref}>
      <TouchTarget>{children}</TouchTarget>
    </link_1.Link>) : (<Headless.Button {...props} className={(0, clsx_1.default)(classes, 'cursor-default')} ref={ref}>
      <TouchTarget>{children}</TouchTarget>
    </Headless.Button>);
});
/**
