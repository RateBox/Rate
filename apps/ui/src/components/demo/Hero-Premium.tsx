...
export function HeroPremium({
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900">
      ...
      <Container className="relative px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-32">
          ...
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-8">
            ...
            <div className="flex flex-col justify-center lg:col-span-6">
              <div className="mx-auto max-w-xl text-center lg:mx-0 lg:text-left">
                ...
                <Heading
                  tag="h1"
                  className="mb-6 bg-gradient-to-r from-gray-900 via-indigo-900 to-purple-900 bg-clip-text text-4xl font-bold tracking-tight text-transparent dark:from-gray-100 dark:via-indigo-100 dark:to-purple-100 sm:text-5xl lg:text-6xl"
                >
                  {component.title}
                </Heading>
                
                {component.subTitle && (
                  <Paragraph className="mb-8 text-lg leading-relaxed text-gray-600 dark:text-gray-300">
                    {component.subTitle}
                  </Paragraph>
                )}
                  ...
                  <div className="flex flex-col gap-4 sm:flex-row sm:gap-6">
                    {component.links.map((link, index) => (
                      <StrapiLink
                        ...
                        component={link}
                        className={cn(
                          "group inline-flex items-center justify-center gap-2 rounded-xl px-6 py-3 text-base font-semibold transition-all duration-200",
                          index === 0
