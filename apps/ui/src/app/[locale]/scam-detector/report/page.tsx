...
export default async function SubmitReportPage(props: Props) {
      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Help protect the community by reporting suspicious activities, scams, or fraudulent organizations.
          </p>
        </div>
