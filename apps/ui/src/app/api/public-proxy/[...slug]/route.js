...
exports.DELETE = exports.PUT = exports.POST = exports.GET = exports.HEAD = void 0;
...
async function handler(request, { params }) {
    ...
    const injectedAuthHeader = `Bearer ${isReadOnly
        ? env_mjs_1.env.STRAPI_REST_READONLY_API_KEY
        : env_mjs_1.env.STRAPI_REST_CUSTOM_API_KEY}`;
    return fetch(url, {
        headers: {
