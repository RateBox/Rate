...
export default function SingleListingDemo() {
  return (
    <ListingDetailTemplateOne
      title="Cafe Horizon"
      slug="cafe-horizon"
      description="A cozy spot offering artisan coffee and fresh pastries with a city view."
      address="12 Nguyen Trai, District 1, Ho Chi Minh City"
      rating={4.7}
      priceLabel="$$"
      images={[
        { url: "/img/banner-6.jpg", alt: "Cover" },
        { url: "/img/l-1.jpg", alt: "Gallery 1" },
        { url: "/img/l-2.jpg", alt: "Gallery 2" },
        { url: "/img/l-3.jpg", alt: "Gallery 3" },
      ]}
      features={[
        { label: "Free Wi‑Fi" },
