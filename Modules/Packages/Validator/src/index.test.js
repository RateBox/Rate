...
describe('validateScamReport', () => {
    it('should return valid=true for correct data', () => {
        ...
        expect((0, index_1.validateScamReport)(data)).toEqual({ valid: true, data });
    });
    it('should return valid=false if missing phone', () => {
        ...
        const result = (0, index_1.validateScamReport)(data);
    ...
    it('should return valid=false if phone is not string', () => {
        ...
        expect((0, index_1.validateScamReport)(data)).toEqual({ valid: false, error: 'Missing or invalid phone' });
    });
