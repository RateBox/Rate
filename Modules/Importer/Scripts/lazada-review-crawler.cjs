...
// Usage: node lazada-review-crawler.cjs <lazada_product_url_or_itemid> [maxPages]
...
if (!input) {
  console.log('Cách dùng: node lazada-review-crawler.cjs <lazada_product_url_or_itemid> [maxPages]');
  process.exit(1);
}
