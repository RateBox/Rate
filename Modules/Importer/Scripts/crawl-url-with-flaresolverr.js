// Scripts/crawl-url-with-flaresolverr.js
// Crawl bất kỳ URL nào qua FlareSolverr và lưu HTML trả về
const axios = require('axios');
const fs = require('fs');

const url = process.argv[2];
if (!url) {
  console.error('Usage: node crawl-url-with-flaresolverr.js <url>');
  process.exit(1);
}
