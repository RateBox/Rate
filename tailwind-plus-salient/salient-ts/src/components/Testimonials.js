...
const avatar_1_png_1 = __importDefault(require("@/images/avatars/avatar-1.png"));
const avatar_2_png_1 = __importDefault(require("@/images/avatars/avatar-2.png"));
const avatar_3_png_1 = __importDefault(require("@/images/avatars/avatar-3.png"));
const avatar_4_png_1 = __importDefault(require("@/images/avatars/avatar-4.png"));
const avatar_5_png_1 = __importDefault(require("@/images/avatars/avatar-5.png"));
const testimonials = [
    [
        {
...
function QuoteIcon(props) {
    return (<svg aria-hidden="true" width={105} height={78} {...props}>
...
function Testimonials() {
    return (<section id="testimonials" aria-label="What our customers are saying" className="bg-slate-50 py-20 sm:py-32">
      <Container_1.Container>
        ...
        <ul role="list" className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-6 sm:gap-8 lg:mt-20 lg:max-w-none lg:grid-cols-3">
          {testimonials.map((column, columnIndex) => (<li key={columnIndex}>
              <ul role="list" className="flex flex-col gap-y-6 sm:gap-y-8">
                {column.map((testimonial, testimonialIndex) => (<li key={testimonialIndex}>
                    <figure className="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                      ...
                      <figcaption className="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6">
                        ...
                        <div className="overflow-hidden rounded-full bg-slate-50">
                          <image_1.default className="h-14 w-14 object-cover" src={testimonial.author.image} alt="" width={56} height={56}/>
                        </div>
                      </figcaption>
                    </figure>
                  </li>))}
