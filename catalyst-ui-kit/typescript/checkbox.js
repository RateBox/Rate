...
exports.Checkbox = exports.CheckboxField = exports.CheckboxGroup = void 0;
const Headless = __importStar(require("@headlessui/react"));
const clsx_1 = __importDefault(require("clsx"));
function CheckboxGroup({ className, ...props }) {
    return (<div data-slot="control" {...props} className={(0, clsx_1.default)(className, 
        // Basic groups
        'space-y-3', 
        // With descriptions
...
function Checkbox({ color = 'dark/zinc', className, ...props }) {
    return (<Headless.Checkbox data-slot="control" {...props} className={(0, clsx_1.default)(className, 'group inline-flex focus:outline-hidden')}>
