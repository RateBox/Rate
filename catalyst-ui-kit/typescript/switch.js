...
exports.Switch = exports.SwitchField = exports.SwitchGroup = void 0;
...
function Switch({ color = 'dark/zinc', className, ...props }) {
    return (<Headless.Switch data-slot="control" {...props} className={(0, clsx_1.default)(className, 
        // Base styles
        ...
        colors[color])}>
      <span aria-hidden="true" className={(0, clsx_1.default)(
        // Basic layout
