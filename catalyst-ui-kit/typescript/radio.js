...
exports.Radio = exports.RadioField = exports.RadioGroup = void 0;
const Headless = __importStar(require("@headlessui/react"));
const clsx_1 = __importDefault(require("clsx"));
function RadioGroup({ className, ...props }) {
    return (<Headless.RadioGroup data-slot="control" {...props} className={(0, clsx_1.default)(className, 
        // Basic groups
...
function RadioField({ className, ...props }) {
    return (<Headless.Field data-slot="field" {...props} className={(0, clsx_1.default)(className, 
        // Base layout
...
function Radio({ color = 'dark/zinc', className, ...props }) {
    return (<Headless.Radio data-slot="control" {...props} className={(0, clsx_1.default)(className, 'group inline-flex focus:outline-hidden')}>
      <span className={(0, clsx_1.default)([base, colors[color]])}>
        <span className={(0, clsx_1.default)('size-full rounded-full border-[4.5px] border-transparent bg-(--radio-indicator) bg-clip-padding', 
        // Forced colors mode
